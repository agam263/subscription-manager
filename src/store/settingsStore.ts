    ...
    (set, get) => ({
      ...
      fetchSettings: async () => {
        ...
        try {
          ...
          // Get exchange rate data and configuration status
      ...
      fetchExchangeRates: async () => {
        try {
          ...
          // Keep existing exchange rates and do not update error status as this may be running in the background
        }
      },
      ...
      updateExchangeRatesFromApi: async () => {
        try {
          ...
          // Re-obtain the exchange rate after the update is successful
      ...
      fetchExchangeRateConfigStatus: async () => {
        try {
          ...
          // Do not set error status as this is not critical functionality
        }
      },
