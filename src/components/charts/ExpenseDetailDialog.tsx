  ...
  const fetchPaymentData = useCallback(async () => {
    ...
    try {
      ...
      if (periodData.periodType === 'monthly') {
        // Monthly data: Get data directly from payment-history API
        ...
        // Quarterly or annual data: Get data for the entire time range directly from the payment-history API
        const startDate = new Date(periodData.startDate)
        const endDate = new Date(periodData.endDate)
